class Game {
  ...
  start() {
    ...
    this.addSprites(powerCoins, 2, p1, 0.3);
    this.addSprites(powerCoins, 2, p2, 0.3);
    this.addSprites(powerCoins, 2, p3, 0.3);
    this.addSprites(powerCoins, 2, p4, 0.3);
    this.addSprites(powerCoins, 2, p5, 0.3);
    this.addSprites(powerCoins, 2, p7, 0.3);
    this.addSprites(powerCoins, 2, p8, 0.3);
  ...
  addSprites(spriteGroup, numberOfSprites, spriteImage, scale, positions = []) {
    ...
    for (var i = 0; i < numberOfSprites; i++) {
      ...
      if (positions.length > 0) {
        x = positions[i].x;
        y = positions[i].y;
        spriteImage = obs[Math.round(random(0,obs.length-1))]
      ...
      //spriteGroup.setVelocityYEach(0.02);
    }
  }
...
if(!moj.isPlaying()){
  moj.play();
    ...
    //  obstacles.setVelocityYEach(0.2);              
